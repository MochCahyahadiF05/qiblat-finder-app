  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QiblahDirection>(
      ...
      builder: (context, AsyncSnapshot<QiblahDirection> snapshot) {
        ...
        final qiblah = qiblahDirection.qiblah; // Arah kiblat (tetap)
        
        // Hitung offset sendiri dengan formula yang benar
        double offset = (qiblah - direction);
        
        // Normalisasi offset agar selalu -180 sampai 180
        while (offset > 180) offset -= 360;
        while (offset < -180) offset += 360;
        
        // Ambil nilai absolut untuk display
        final absOffset = offset.abs();
        
        // Debug: Print semua nilai
        print('=== QIBLAH DEBUG ===');
        print('Direction (HP): ${direction.toStringAsFixed(2)}°');
        print('Qiblah: ${qiblah.toStringAsFixed(2)}°');
        print('Calculated Offset: ${absOffset.toStringAsFixed(2)}°');
        print('Original Offset: ${qiblahDirection.offset.toStringAsFixed(2)}°');
        print('====================');
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: absOffset < 5 ? Colors.green[700] : Colors.orange[700],
                      borderRadius: BorderRadius.circular(25),
                      boxShadow: [
                        BoxShadow(
                          color: (offset.abs() < 5 ? Colors.green[700]! : Colors.orange[700]!)
                              .withOpacity(0.3),
                          blurRadius: 8,
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          absOffset < 5 ? Icons.check_circle : Icons.explore,
                          color: Colors.white,
                          size: 20,
                        ),
                        const SizedBox(width: 8),
                        Text(
                          absOffset < 5 ? 'Menghadap Kiblat' : 'Cari Arah Kiblat',
                  ...
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        // Panah KIBLAT (merah/hijau) - BERPUTAR sesuai QIBLAH
                        Transform.rotate(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    'HP: ${direction.toStringAsFixed(0)}°',
                                    style: TextStyle(
                                      fontSize: 12,
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.mosque, size: 14, color: Colors.red[700]),
                                  const SizedBox(width: 4),
                                  Text(
                  ...
                  Container(
                    ...
                    margin: const EdgeInsets.symmetric(horizontal: 20),
                    decoration: BoxDecoration(
                      color: absOffset < 5 ? Colors.green[50] : Colors.blue[50],
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: absOffset < 5 ? Colors.green[300]! : Colors.blue[200]!, 
                        width: absOffset < 5 ? 2 : 1
                      ),
                    ),
                    child: Row(
                      children: [
                        Icon(
                          absOffset < 5 ? Icons.check_circle : Icons.info_outline, 
                          color: absOffset < 5 ? Colors.green[700] : Colors.blue[700]
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(
                            absOffset < 5
                                ? '✓ Sempurna! HP sudah menghadap kiblat dengan benar'
                                : 'Putar HP hingga angka selisih mendekati 0°',
                            style: TextStyle(
                              fontSize: 13,
                              color: absOffset < 5 ? Colors.green[900] : Colors.blue[900],
                              fontWeight: absOffset < 5 ? FontWeight.bold : FontWeight.normal,
                            ),
                          ),
                        ),
                      ],
...
class CompassPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 360; i += 6) {
      ...
      final startRadius = isMainDirection ? radius - 25 : 
                         isMidDirection ? radius - 18 : 
                         radius - 12;
      ...
      final linePaint = Paint()
        ..color = isMainDirection ? Colors.red[700]! : 
                 isMidDirection ? Colors.grey[600]! : 
                 Colors.grey[400]!
        ..strokeWidth = isMainDirection ? 3 : isMidDirection ? 2 : 1;
